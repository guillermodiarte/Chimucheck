...
import { Calendar, Users, Trophy, Gamepad2, AlertCircle } from "lucide-react";
...
export default async function DashboardTournamentDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="relative w-full rounded-3xl overflow-hidden min-h-[80vh] border border-white/10">
      ...
      <div className="relative z-10 w-full">
        <div className="bg-transparent">
          ...
          <div className="group relative aspect-video w-full max-h-[400px]">
            ...
            <div className="absolute bottom-0 left-0 p-8 w-full">
              ...
              <h1 className="text-3xl md:text-5xl font-black text-white uppercase drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)] mb-2 leading-tight">
                {tournament.name}
              </h1>
            </div>
          </div>

          <div className="p-8 grid gap-8 md:grid-cols-3 bg-zinc-900/40 backdrop-blur-sm">
            {/* Left Column: Info */}
